...
exports.getActivePackDataByTypeAndCity = async (packType, cityId) => {
    return new Promise((resolve, reject) => {
        let sql = "SELECT" +
            "`ActivePackItem`.`active_pack_item_title`, `ActivePackItem`.`active_pack_item_content`, `ActivePackItem`.`active_pack_item_start_time`, `ActivePackItem`.`active_pack_item_end_time`, `ActivePack`.`active_pack_type`, `ActivePack`.`city_id`" +
            "FROM `ActivePackItem`" +
