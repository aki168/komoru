      ...
      <div style={{ margin: "0 0 0 60px" }}>
        ...
        <div className="row">
          <div className="col-6">
            ...
            <div className=" d-flex align-items-center ">
              <h5 className="col-4">性別</h5>
              <p className="col-4">{orderMemberData.memberGender}</p>
            </div>
          </div>
          <div className="col-6">
            <div className=" d-flex align-items-center">
