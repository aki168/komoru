...
export const TaichungSliderDes = [
  { description: "台中-Star Hostel" },
  { description: "台中:Star Hostel-私人套房" },
  { description: "台中:Star Hostel-背包客房" },
];
...
export const TainanSliderDes = [
  { description: "台南-快活慢行" },
  { description: "台南:快活慢行-私人套房" },
  { description: "台南:快活慢行-背包客房" },
];
...
export const HualienSliderDes = [
  { description: "花蓮-山林山鄰" },
  { description: "花蓮:山林山鄰-私人套房" },
  { description: "花蓮:山林山鄰-背包客房" },
];
...
export const TaipeiSliderDes = [
  { description: "台北-夾腳拖的家" },
  { description: "台北:夾腳拖的家-私人套房" },
  { description: "台北:夾腳拖的家-背包客房" },
];
