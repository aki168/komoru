...
function getAngle(startPoint, arcPath) {
    var _a;
    var _b = (0, g_canvas_1.getArcParams)(startPoint, arcPath), startAngle = _b.startAngle, endAngle = _b.endAngle, arcFlag = _b.arcFlag;
    ...
    if ((0, util_1.isNumberEqual)(endAngle, Math.PI * -0.5) && arcFlag) {
